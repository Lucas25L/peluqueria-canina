...
public class ModificarDatos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnVolver.setMaximumSize(new java.awt.Dimension(30, 7));
        btnVolver.setMinimumSize(new java.awt.Dimension(30, 7));
        btnVolver.setPreferredSize(new java.awt.Dimension(30, 7));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        // PASAMOS TODOS LOS PARAMETROS A LA CONTROLADORALOGICA
        control.modificarMascota(masco, nombreMasco, razaMasco,
                colorMasco, obsMasco, alergicoMasco, atencionEspecial,
                nombreDue, celuDue);
        
        
        JOptionPane optionPane = new JOptionPane("Los cambios se guardaron correctamente");
        optionPane.setMessageType(JOptionPane.INFORMATION_MESSAGE);
        JDialog dialog = optionPane.createDialog("Cambios exitoso");
    ...
    private void btnVolverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVolverActionPerformed
        VerDatos pantallaPrincipal = new VerDatos();
    ...
    private void cargarMascota() {
        if (masco != null){
            ...
            txtCelular.setText(masco.getDuenio().getNumCelular());
            txtColor.setText(masco.getColor());
            txtAlergia.setText(masco.getAlergico());
            txtNombreDueño.setText(masco.getDuenio().getNombreDuenio());
            txtRaza.setText(masco.getRaza());
            areaObservacion.setText(masco.getObservacion());
            
            if (masco.getAlergico().equalsIgnoreCase("si")){
                comboAlergia.setSelectedIndex(1);
            } else {
                comboAlergia.setSelectedIndex(2);
            }
